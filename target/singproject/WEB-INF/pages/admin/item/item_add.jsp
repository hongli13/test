...
<div class="layui-layout layui-layout-admin">
        ...
        <div style="padding: 15px;">
            <div class="layui-container">
                <form class="layui-form">
                    <h2 class="layui-col-md-offset2">增加分类</h2>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="note" class="layui-textarea" required lay-verify="required" placeholder="请输入分类描述"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
    ...
    <script src="<%=basePath%>js/item_add.js"></script>
